...
public class AOSapp extends AppModelBase {		private Homepage Homepage;
	
	public AOSapp(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("AOSapp");
	...
	private Login Login;
						public Homepage(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
					...
					UserMenu = new UserMenu(this, applicationModel);
		...
		protected com.hp.lft.sdk.web.PageDescription createDescription() throws GeneralLeanFtException{
			...
			return description;
				...
				public UserMenu UserMenu() { return UserMenu; }
		public Username Username() { return Username; }
		public Password Password() { return Password; }
		public Login Login() { return Login; }
		
			public class UserMenu extends LinkNodeBase
	{

		
								public UserMenu(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		...
		protected com.hp.lft.sdk.web.LinkDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.LinkDescription.Builder().tagName("A").innerText("My account My orders Sign out ").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class Username extends EditFieldNodeBase
	{
		...
		protected com.hp.lft.sdk.web.EditFieldDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.EditFieldDescription.Builder().tagName("INPUT").name("username").type("text").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class Password extends EditFieldNodeBase
	{
		...
		protected com.hp.lft.sdk.web.EditFieldDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.web.EditFieldDescription description = null; 
			try{
				description = new com.hp.lft.sdk.web.EditFieldDescription.Builder().tagName("INPUT").name("password").type("password").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class Login extends ButtonNodeBase
	{
								...
								public Login(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			...
			setDisplayName("sign_in_btnundefined");
		}
		...
		protected com.hp.lft.sdk.web.ButtonDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.web.ButtonDescription.Builder().tagName("BUTTON").name("SIGN IN").buttonType("button").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
